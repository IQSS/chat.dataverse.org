	...
	<div id="viewport">
		...
		<div id="main">
			<div id="windows">
				...
				<div id="connect" data-title="Chat about Dataverse with users and developers" class="window">
					<div class="header">
						<button class="lt"></button>
					</div>
					<form class="container" action="">
						<div class="row">
							<div class="col-sm-12">
								<!--<h1 class="title">Chat about Dataverse!</h1>-->
								<a href="http://dataverse.org/"><img src="img/dataverse_project_logo.png" width="300"/></a>
							</div>
							...
							<div class="col-sm-12">
								<h4>Welcome! To chat with <a href="http://dataverse.org">Dataverse</a> users and developers, please pick a username.</h4>
								<h4>Please note that chat is publicly logged at <a href="http://irclog.iq.harvard.edu/dataverse/today">irclog.iq.harvard.edu</a></h4>
								<br/>
							</div>
							<div class="col-sm-3">
